...
import {UniswapV3Adapter, ISwapRouter, IQuoterV2} from "../../../src/adapters/UniswapV3Adapter.sol";
...
/// @dev Mock Uniswap V3 SwapRouter that simulates swaps with fee-dependent rates.
...
/// @notice Unit tests for UniswapV3Adapter DEX adapter.
contract UniswapV3AdapterTest is Test {
    ...
    function setUp() public {
        ...
        adapter = new UniswapV3Adapter(address(mockRouter), address(mockQuoter));
    ...
    function test_revertWhen_constructorZeroRouter() public {
        ...
        new UniswapV3Adapter(address(0), address(mockQuoter));
    }

    function test_revertWhen_constructorZeroQuoter() public {
        vm.expectRevert(IDEXAdapter.InvalidToken.selector);
        new UniswapV3Adapter(address(mockRouter), address(0));
    }
    ...
    function test_revertWhen_multiHopPathLengthMismatch() public {
        ...
        bytes memory extraData = abi.encode(fees, intermediates);
        vm.expectRevert(UniswapV3Adapter.PathLengthMismatch.selector);
